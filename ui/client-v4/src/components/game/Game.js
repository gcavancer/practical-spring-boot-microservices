...
import { restartGame, registerAttempt, getStats } from "./actions";
...
class Game extends Component {
  componentDidMount = () => {
    ...
    // this.props.getStats(this.props.alias);
  };
    ...
    return (
      <div className="container-fluid">
        ...
        <div className="mt-3">
          ...
          <h2>User Stats</h2>
          <p>
            <span className="badge">{this.props.alias} has {this.props.wins} wins.</span>
          </p>
        </div>
        {guessOutcomePara}
      </div>
